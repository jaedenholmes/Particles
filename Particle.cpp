...
Particle::Particle(RenderTarget& target, int numPoints, Vector2i mouseClickPosition) : m_A(2, numPoints)
{
    ...
    //will generate negative or postive horizonatal velocity,
    //deciding if the particle goes left or right
    if (m_vx != 0) m_vx *= -1;
    ...
    float theta = randomFraction * (M_PI / 2);
...
//constructs matrix T and adds to m_A
